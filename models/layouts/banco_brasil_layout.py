...
class BancoBrasilLayoutModel(BaseLayout):
    """
    Layout responsável por interpretar extrato do Banco do Brasil.
    ...
    def _parse_linha(self, linha: str) -> dict | None:
        ...
        01/01/2026 PIX MERCADO CENTRAL 123456 250,00 D
        01/01/2026 TED RECEBIDA 2.500,00 C
        """
